<div class="container">
  ...
  <form action="./server/requests.php" method="post">
    ...
    <div class="col-12 col-md-6 offset-md-3 margin-bottom-15">
      ...
      <textarea name="description" class="form-control" id="description" placeholder="Enter Question Description"
        required></textarea>
    </div>
   ...
   <div class="col-12 col-md-6 offset-md-3 margin-bottom-15">
      <button type="submit" name="ask" class="btn btn-primary bls">Ask Question</button>
    </div>
